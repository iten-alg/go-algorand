...
type OpStream struct {
	...
	lastOpWasIntcBlock  bool                  // Delays setting of hasIntcBlock/hasMultipleIntcBlocks until we see the next op so that terminating intcblocks do not interfere
	delayedIntc         []uint64              // Delays setting of intc so we only set intc to a non-terminating block
	...
	lastOpWasBytecBlock  bool                  // Delays setting of hasBytecBlock/hasMultipleBytecBlocks until we see the next op so that terminating bytecblocks do not interfere
